...
**47 first-party skills**, a **12-command CLI**, and a **curated catalog** of optional third-party packs. Agent skills and CLI for Cursor, Codex, Claude Code, Antigravity CLI/IDE, Gemini CLI, OpenCode, and other harnesses that read `SKILL.md` files.
...
| Asset | Count | Detail |
| --- | ---: | --- |
| Kenmark skills | 47 | Bundled in `skills/user-skills/` |
| CLI commands | 12 | [brain/kb/05-api-and-integrations.md](brain/kb/05-api-and-integrations.md) |
| Recommended packs | 7 | Impeccable, Simplify, Graphify, Headroom, SEO, ECC — [brain/kb/features/004-recommended-packs.md](brain/kb/features/004-recommended-packs.md) |
...
Migration: `setup -y` → `init --skip-recommended -y`. Legacy `setup` runs **Install 47 Kenmark skills** via `setup-skills.js`.

| | `init` | `setup` |
| --- | --- | --- |
| **Installs** | Kenmark + optional packs | 47 Kenmark skills |
...
└── skills/user-skills/     # 47 universal skills + recommended-catalog.json
```
