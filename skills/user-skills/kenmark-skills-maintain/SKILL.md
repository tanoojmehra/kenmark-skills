...
Pair with **kenmark-setup** for first-time setup (humans: interactive wizard; agents: `init -y`), the packs section in **kenmark-setup** when adding curated packs after cleanup, and **kenmark-update** when refreshing Kenmark or recommended installs.
...
- `impeccable`, `kenmark-router`, `find-skills`, `kenmark-init`, `kenmark-commit`, `kenmark-troubleshoot`, Kenmark `repo-*` skills (`kenmark-repo-hygiene`, `kenmark-repo-secrets`, `kenmark-repo-public`, `kenmark-kb-sync`, `kenmark-repo-docs`, `kenmark-repo-deps`, `kenmark-repo-quality`, `kenmark-repo-release`), `kenmark-security-review`, `kenmark-performance`, Kenmark `tracker-*` / `skills-*` skills (including `kenmark-setup`)
...
2. Suggest **kenmark-setup** (packs section) if they want a minimal curated set
