...
- **Never** delete, move, or edit files unless the user explicitly switches to a cleanup skill (`repo-hygiene` with approval).
...
Use this template in chat. For complex audits, offer `brain/reports/repo-secrets-audit-YYYY-MM-DD.md` when `brain/` exists.
...
| Situation | Prefer |
| --- | --- |
| Clutter, scattered MD, dumps, approved cleanup | `repo-hygiene` |
| Safe to make repo public (full gate) | `repo-public-readiness` |
| Docs accuracy, README setup | `repo-docs-audit` |
| Before npm publish / GitHub release | `repo-release-readiness` |
| Pick skill | `skills-router` |
