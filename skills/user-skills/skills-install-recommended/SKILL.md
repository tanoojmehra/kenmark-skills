---
name: skills-install-recommended
version: 2.0.0
category: admin
scope: universal
phase: setup
...
- After **skills-maintain** cleanup when rebuilding a lean set
- For refresh only, use **skills-update**
...
Run **skills-maintain** inventory to catch duplicate explosion.

## Step 5 — Kenmark first-party skills

Kenmark skills are the **curator OS** (router, maintain, install-recommended, update, init-brain, commit-push, issues-*):
